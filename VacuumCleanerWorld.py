...
class VacuumCleanerWorld:
    ...
    def getActions(self):
        ...
        if vacuumPosition == positions.ROOM1:
            if self.room1state == self.DIRTY:
    ...
    def toString(self):
        return f"{self.vacuumPosition}, {self.room1State}, {self.room2State}, {self.room3State}"
